/**
 * nRF Web Tool
 * Standalone library for installing DFU packages to nRF52 devices via Web Serial
 * 
 * Usage:
 ...
 *   - Web Serial API support (Chrome/Edge)
  ...
  async startInstall() {
    ...
    if (!navigator.serial) {
      this.renderPage('ERROR', {
        ...
        details: 'Please use Google Chrome or Microsoft Edge to use this tool.'
      });
      return;
    }
